...
{	
	...
	glClear(GL_COLOR_BUFFER_BIT|GL_DEPTH_BUFFER_BIT);
		...
		/lower potion of the stick/
			...
			/to create the sharp spikes for the devil weapon/
			...
			/to create a cube inisde the sphere for the devil weapon/
			...
			/X creating the leg of the devil X/
			...
			glTranslatef(0,.38,0);
			//glutSolidCube(.3);
			/X creatin the leg of the devil X/

		
			/creating the plate on which the devil stands/
			...
			/creating the ring on devils head/
